  ...
  return (
    ...
    >
      <div className="absolute  w-[100%]">
        <div className="bg-[#166e48] pt-3 pb-3">
          <button
        ...
        <div className=" pt-5">
          <div className="flex items-center flex-col">
            <img
              className="w-[150px] h-[150px] rounded-[100%] -ml-5 border-[5px] border-black border-solid"
              src={
        ...
        <div
          onClick={logoutUser}
          className="flex items-center justify-center mt-5 cursor-pointer shadow-2xl mb-[5%]"
        >
