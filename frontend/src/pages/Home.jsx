...
function Home() {
  ...
  return (
    <>
      <div className="h-[100vh] w-[98%] mx-auto shadow-2xl mb-8 overflow-hidden">
        <div className="flex">
          {!showProfile ? (
            <div className="md:flex md:flex-col min-w-[360px] h-[100vh] md:h-[98.6vh] bg-[#ffff] border-r-1 relative">
                ...
                <div className="relative pt-2 px-4">
                  <form onSubmit={(e) => e.preventDefault()}>
                    <input
                      ...
                      className="text-[15px] w-[90%] bg-[#f6f6f6] text-[#111b21] pl-3 py-1 mx-3 rounded-[9px] outline-2"
                      type="text"
                      name="search"
                      placeholder="🔎 Search"
                    />
            ...
            <Profile className="w-[38%] h-[100vh] bg-[#fafafa] shodow-xl relative overflow-y-scroll overflow-x-hidden" />
          )}
          <Chat className="relative lg:w-[100%] h-[100vh]" />
        </div>
      </div>
    </>
  );
