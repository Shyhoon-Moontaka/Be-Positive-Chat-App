    ...
    <div className="w-[100vw] h-[100vh] flex justify-center items-center">
      <div className="w-[90%] sm:w-[400px] pl-0 ml-0 h-[400px] sm:pl-0 sm:ml-9 mt-10 relative">
        <div className="absolute -top-7 left-0">
          <h3 className=" text-[25px] font-bold tracking-wider">Register</h3>
          <p className="text-[12px] tracking-wider font-medium">
            Have Account ?{" "}
            <Link className="text-[green] underline" to="/">
              Sign in
            </Link>
          </p>
        </div>
        ...
        >
          <div className="flex gap-x-2 w-[100%]">
            <input
              ...
              className="bg-[#222222] h-[50px] pl-3 text-[#ffff] w-[49%] sm:w-[47%] rounded-2xl"
              type="text"
              name="firstname"
          ...
          <div>
            <input
              onChange={handleOnChange}
              className="bg-[#222222] h-[50px] pl-3 text-[#ffff] w-[100%] sm:w-[96.3%] rounded-2xl"
              type="email"
              name="email"
              placeholder="Email"
          ...
          <button
            className="w-[100%] bg-[blue] rounded-2xl sm:w-[96.3%] h-[50px] font-bold text-[white] text-[17px] relative"
            type="submit"
          >
            <div
          ...
          <div className="w-[50%] mx-auto border-3">
            <GoogleOAuthProvider
